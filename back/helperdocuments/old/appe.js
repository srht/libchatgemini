    ...
    const messages = [
      {
        role: "system",
        content:
          "Sen yardımcı bir asistansın. Kullanıcının sorusunda geçen terimlerin (örneğin 'gömme' kelimesi 'embedding' anlamına gelir) farklı ifadelerini de dikkate alarak aşağıdaki bağlamı kullanarak cevap ver. Eğer bağlamda bilgi yoksa, 'Üzgünüm, bu konu hakkında belgemde yeterli bilgi bulunmuyor.' şeklinde yanıtla. Sadece bağlamdaki bilgilere sadık kal",
      },
      {
        role: "user",
