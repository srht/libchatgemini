...
try {
  getSearchTool = new DynamicTool({
    name: "get_books",
    description: `Kütüphane kataloğundaki yayınları bulur. Input should be a keyword string. 'Mesela denemeler kitabı var mı?' sorusu için 'denemeler' kelimesini kullan.
    ...
    func: async (input) => {
      ...
      try {
        ...
        console.log(`[FETCH YANITI] Data:`, JSON.stringify(books, null, 2));
